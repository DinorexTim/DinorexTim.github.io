...
<img src="https://github.com/DINOREXNB/DINOREXNB.github.io/blob/main/docs/images/xsyy10-6.png?raw=true" style="width:300px">
...
2. 对$\forall(p,Y_1Y_2\dots Y_n)\in \delta(q,a,X)$构造$|Q|^n$个产生式$[qXr_n]\to a[pY_1r_1][r_1Y_2r_2]\dots[p_{n-1}Y_nr_n]$


例：将PDA $P=(\{q_0,q_1\},(0,1),\{X,Z_0\},\delta,q_0,Z_0)$转为CFG

<img src="https://github.com/DINOREXNB/DINOREXNB.github.io/blob/main/docs/images/xsyy10-7.png?raw=true" style="width:300px">
