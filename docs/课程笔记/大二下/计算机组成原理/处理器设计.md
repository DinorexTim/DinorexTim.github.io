...
![img](https://github.com/dinorextim/dinorextim.github.io/blob/main/docs/images/jz6-1.png?raw=true){width=300 align=right}
...
![img](https://github.com/dinorextim/dinorextim.github.io/blob/main/docs/images/jz6-2.png?raw=true){width=300 align=right}
...
![img](https://github.com/dinorextim/dinorextim.github.io/blob/main/docs/images/jz6-3.png?raw=true){width=300}
...
![img](https://github.com/dinorextim/dinorextim.github.io/blob/main/docs/images/jz6-4.png?raw=true){width=450}

### 实现sub指令

与`add`几乎相同，inst[30]在加法和减法之间进行选择

![img](https://github.com/dinorextim/dinorextim.github.io/blob/main/docs/images/jz6-5.png?raw=true){width=450}

### 实现addi指令

在`sub`电路中的`Reg[rs2]`处添加一个多路复用器用于选择立即数与`Reg[rs2]`，并且将12位的立即数扩展为32位

![img](https://github.com/dinorextim/dinorextim.github.io/blob/main/docs/images/jz6-6.png?raw=true){width=450}

#### I型指令的立即数生成

![img](https://github.com/dinorextim/dinorextim.github.io/blob/main/docs/images/jz6-7.png?raw=true){width=450}
...
![img](https://github.com/dinorextim/dinorextim.github.io/blob/main/docs/images/jz6-8.png?raw=true){width=450}
...
![img](https://github.com/dinorextim/dinorextim.github.io/blob/main/docs/images/jz6-9.png?raw=true){width=450}

> 在ld基础上，将rs2地址传入DM以进行写操作

#### I型指令与S型指令的立即数生成

![img](https://github.com/dinorextim/dinorextim.github.io/blob/main/docs/images/jz6-10.png?raw=true){width=450}
...
![img](https://github.com/dinorextim/dinorextim.github.io/blob/main/docs/images/jz6-11.png?raw=true){width=450}
...
![img](https://github.com/dinorextim/dinorextim.github.io/blob/main/docs/images/jz6-12.png?raw=true){width=450}
...
![img](https://github.com/dinorextim/dinorextim.github.io/blob/main/docs/images/jz6-13.png?raw=true){width=450}
...
![img](https://github.com/dinorextim/dinorextim.github.io/blob/main/docs/images/jz6-14.png?raw=true){width=450}

### U型指令——aupic

![img](https://github.com/dinorextim/dinorextim.github.io/blob/main/docs/images/jz6-15.png?raw=true){width=450}
...
![img](https://github.com/dinorextim/dinorextim.github.io/blob/main/docs/images/jz7-2.png?raw=true){width=450}
